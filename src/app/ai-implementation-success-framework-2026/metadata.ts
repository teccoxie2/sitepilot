...
const metadataConfig: Metadata = {
  ...
  keywords:
    'ai implementation success framework, enterprise ai implementation 2026, ai transformation roadmap, ai rollout success metrics, ai implementation governance',
  alternates: {
    canonical: pageUrl,
  },
  openGraph: {

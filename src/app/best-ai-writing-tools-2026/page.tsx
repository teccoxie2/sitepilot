      ...
      <div className="bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-900 mb-4">We evaluated each AI writing tool based on:</p>
              ...
              <table className="w-full bg-white border border-slate-200 rounded-lg">
                ...
                <tbody className="divide-y divide-gray-200">
                  <tr>
                    ...
                    <td className="px-4 py-3 text-gray-900">Overall writing</td>
                    <td className="px-4 py-3 text-gray-900">$29/month</td>
                    <td className="px-4 py-3 text-gray-900">7-day trial</td>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3 text-gray-900">Bloggers</td>
                    <td className="px-4 py-3 text-gray-900">$36/month</td>
                    <td className="px-4 py-3 text-gray-900">2K words</td>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3 text-gray-900">Value seekers</td>
                    <td className="px-4 py-3 text-gray-900">$13/month</td>
                    <td className="px-4 py-3 text-gray-900">2.5K words</td>

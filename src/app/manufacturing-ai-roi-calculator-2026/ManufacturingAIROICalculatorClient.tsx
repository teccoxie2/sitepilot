            ...
            <div className="grid items-center gap-12 lg:grid-cols-[1.08fr_0.92fr]">
              <div className="max-w-3xl">
                ...
                <p className="page-lead mb-8 max-w-2xl text-lg md:text-xl">
                  Model downtime, defects, energy, inventory, and risk-adjusted value in one manufacturing finance view. Treat the output as a planning scenario, not a promise of realized savings.
                </p>

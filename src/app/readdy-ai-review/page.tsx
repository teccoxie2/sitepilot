      ...
      <main className="relative max-w-7xl mx-auto px-4 py-14 md:py-18">
        ...
        <section className="text-center bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-xl mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            <a href="https://readdy.ai/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center rounded-full border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 shadow-sm hover:bg-slate-50 transition-colors">
              Visit Readdy.ai
            </a>
          </div>
        </section>
